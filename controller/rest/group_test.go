...
func TestServiceCreate(t *testing.T) {
...

	{
		...
		cases := map[string]api.RESTServiceConfig{
			"g1":            api.RESTServiceConfig{"g1", "", nil, nil, nil},
			"g1.default":    api.RESTServiceConfig{"g1", "default", nil, nil, nil},
			"external":      api.RESTServiceConfig{"external", "", nil, nil, nil},
			"nodes":         api.RESTServiceConfig{"nodes", "", nil, nil, nil},
			"nv.g2.default": api.RESTServiceConfig{"nv.g2", "default", nil, nil, nil},
			"g2.default":    api.RESTServiceConfig{"g2", "default", nil, &modeMonitor, nil},
			"sys.default":   api.RESTServiceConfig{"sys", "default", nil, nil, &notScored},
		}
		...
		cases = map[string]api.RESTServiceConfig{
			"g1":         api.RESTServiceConfig{"g1", "", nil, nil, nil},
			"g1.default": api.RESTServiceConfig{"g1", "default", nil, nil, nil},
			".":          api.RESTServiceConfig{"", "", nil, nil, nil},
			".default":   api.RESTServiceConfig{"", "default", nil, nil, nil},
			"g2":         api.RESTServiceConfig{"g2", "", nil, &modeEmpty, nil},
			"g3.default": api.RESTServiceConfig{"g2", "default", nil, &modeWrong, nil},
		}
